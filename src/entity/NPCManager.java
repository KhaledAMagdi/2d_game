...
//        npcs[0].solidAreaDefaultX = 0; <-- hitbox
//        npcs[0].solidAreaDefaultY = 0; <-- hitbox
    ...
    public void draw(Graphics2D g2)
    {
        for (Entity npc : npcs) 
        {
            ...
            if(gp.devMode)
            {
                ...
                g2.drawRect(screenX + npcs[0].solidArea.x,screenY + npcs[0].solidArea.y, npcs[0].solidArea.width, npcs[0].solidArea.height);
            }
        } 
    }
}