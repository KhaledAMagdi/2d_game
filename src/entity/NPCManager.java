...
// ---------------Custom made objects---------------//
        ...
        npcs[i].dialogue[0] = "Looking for better swords?\nWell you've found the right place!";
        ...
        npcs[i].direction = "down";
        npcs[i].dialogue = new String[1];
        npcs[i].dialogue[0] = "Looking for better shields?\nWell you've found the right place!";
        npcs[i].moveable = false;
        i++;
        ...
        npcs[i].direction = "down";
        npcs[i].dialogue = new String[1];
        npcs[i].dialogue[0] = "Potions are a mysterious thing.\nYou should try them out.";
        npcs[i].moveable = false;
        i++;
        ...
        npcs[i].direction = "down";
        npcs[i].dialogue = new String[1];
        npcs[i].dialogue[0] = "Take care traveler!\nThis island is a dangerous place.";
        npcs[i].moveable = true;
        i++;
        ...
        npcs[i].direction = "down";
        npcs[i].dialogue = new String[1];
        npcs[i].dialogue[0] = "I may look like just a farmer\nBut trust me I've seen days of rain.";
        npcs[i].moveable = true;
    }
